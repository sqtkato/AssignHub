...
public class CompanyController {
    ...
    @GetMapping
    public String index(
            @RequestParam(name = "companySearch", required = false) String companyNameSearch,
            @RequestParam(name = "companyTelSearch", required = false) String companyTelSearch,
            Model model) {
        model.addAttribute("companies", companyService.findAll(companyNameSearch, companyTelSearch));
        model.addAttribute("companySearch", companyNameSearch);
