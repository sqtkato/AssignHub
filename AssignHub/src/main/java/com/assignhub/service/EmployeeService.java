...
public class EmployeeService {
	 ...
	 * @param empAssignCompany アサイン先企業名（部分一致）
	 * @param empEngineerType  エンジニアタイプ（部分一致）
	 * @param empCompany       所属企業名（部分一致）
	 * @return 社員エンティティのリスト
	 */
	...
	/**
	 * 複数の社員IDを指定して、社員情報をまとめて取得する。
	 *
	 * @param ids 取得対象の社員IDのリスト
	 * @return 社員エンティティのリスト
	 */
	...
	/**
	 * 文字列を日付に変換する。「yyyy/M/d」と「yyyy-M-d」の両形式に対応する。
	 *
	 * @param s 変換対象の文字列
	 * @return 変換した日付（いずれの形式にも合致しない場合はnull）
	 */
